...
namespace AJS.Utility.Ganksystem
{
    ...
    public static class Region
    {
        ...
        public static void Initialize()
        {
            ...
            pts = new[] { new Point(2236, 9200), new Point(4929, 11650), new Point(4100, 12735), new Point(1627, 10631) };
            Regions[Location.TopWard] = pts;

            pts = new[] { new Point(8237, 4960), new Point(10194, 6500), new Point(6567, 9520), new Point(4475, 8200) };
            Regions[Location.MidWard] = pts;

            pts = new[] { new Point(10400, 2500), new Point(13300, 4600), new Point(11800, 5520), new Point(9500, 3400) };
            Regions[Location.BottomWard] = pts;
        }
        ...
        {
            return EntityManager.Heroes.AllHeroes.Where(hero => hero.Position.InWhatRegion() == location).ToList();
        }
        ...
        public static bool InBotWard(Obj_AI_Base unit)
        {
            return IsPointInPolygon(Regions[Location.BottomWard], unit.Position);
        }

        public static bool InTopWard(Obj_AI_Base unit)
        {
            return IsPointInPolygon(Regions[Location.TopWard], unit.Position);
        }

        public static bool InMidWard(Obj_AI_Base unit)
        {
            return IsPointInPolygon(Regions[Location.MidWard], unit.Position);
        }
